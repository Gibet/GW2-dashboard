  ...
  return (
    <div className="grid grid-cols-4 gap-3 text-left justify-between mb-3 text-xs Lato">
      ...
      <div className="col-span-1 flex flex-col">
        ...
        <span className="flex justify-start items-center gap-1">Daily AP: {props.daily_ap.toLocaleString()} <span className="sprite-achievement-icon"></span></span>
        <span className="flex items-center gap-1">Monthly AP: {props.monthly_ap.toLocaleString()} <span className="sprite-achievement-icon"></span></span>
